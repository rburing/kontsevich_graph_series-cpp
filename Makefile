...
bin/poisson_evaluate: bin tests/poisson_evaluate.o kontsevich_graph.o
	$(CC) -o bin/poisson_evaluate tests/poisson_evaluate.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)
...
bin/star_product: bin tests/star_product.o kontsevich_graph.o
	$(CC) -o bin/star_product tests/star_product.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)
...
bin/cyclic_weight_relations: bin tests/cyclic_weight_relations.o kontsevich_graph.o
	$(CC) -o bin/cyclic_weight_relations tests/cyclic_weight_relations.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)
...
bin/substitute_relations: bin tests/substitute_relations.o kontsevich_graph.o
	$(CC) -o bin/substitute_relations tests/substitute_relations.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)

tests/reduce.o:
	$(CC) $(CFLAGS) -c tests/reduce.cpp -o tests/reduce.o

bin/reduce: bin tests/reduce.o kontsevich_graph.o
	$(CC) -o bin/reduce tests/reduce.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)

tests/invert.o:
	$(CC) $(CFLAGS) -c tests/invert.cpp -o tests/invert.o

bin/invert: bin tests/invert.o kontsevich_graph.o
	$(CC) -o bin/invert tests/invert.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)

tests/gauge.o:
	$(CC) $(CFLAGS) -c tests/gauge.cpp -o tests/gauge.o

bin/gauge: bin tests/gauge.o kontsevich_graph.o
	$(CC) -o bin/gauge tests/gauge.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)
...
bin/star_product_associator: bin tests/star_product_associator.o kontsevich_graph.o
	$(CC) -o bin/star_product_associator tests/star_product_associator.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)
...
bin/reduce_mod_jacobi: bin tests/reduce_mod_jacobi.o kontsevich_graph.o
	$(CC) -o bin/reduce_mod_jacobi tests/reduce_mod_jacobi.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)
...
bin/skew_symmetrize: bin tests/skew_symmetrize.o kontsevich_graph.o
	$(CC) -o bin/skew_symmetrize tests/skew_symmetrize.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)
...
bin/reduce_mod_permutations: bin tests/reduce_mod_permutations.o kontsevich_graph.o
	$(CC) -o bin/reduce_mod_permutations tests/reduce_mod_permutations.o kontsevich_graph.o $(LDFLAGS) $(GINAC_LDFLAGS)
